...
export default function Home() {
    return (<>
        ...
        <div className="absolute top-0 right-0 bottom-0 left-0 p-8 m-auto w-max h-max max-w-[1000px] bg-white/90 rounded-md">
            ...
            <ul className="mb-6">
                ...
                <li className="flex items-center gap-2">
                    ...
                    <Link href="/documents/ezra-resume--october-2023.pdf" className="text-blue-500 hover:underline" download>
                        Resume (download)
                    </Link>
                </li>
            </ul>
